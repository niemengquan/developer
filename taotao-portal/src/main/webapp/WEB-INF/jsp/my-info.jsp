    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
			...
			<div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                <li class="fore-1"><a class="curr" href="http://i.tt.com/user/info">基本信息</a></li>
                                <li class="fore-2"><a href="http://i.tt.com/user/userinfo/showImg.html">头像照片</a></li>
                        ...
                        <div class="mc">
...
</strong><a target="_blank" class="ml5 ftx05" href="http://safe.tt.com/validate/updateMail">修改</a><span class="ftx-03">&nbsp;&nbsp;&nbsp;已验证</span>
										</div>
																			</div>
                            ...
                            <div id="user-info">
                                <div class="u-pic">
                                    ...
                                    <a href="http://i.tt.com/user/userinfo/showImg.html" class="face-link">修改头像</a>
                                </div>
                                <div class="info-m">
									<div><b>用户名：dh189</b></div>
                                    <div class="u-level">
										<span class="rank r4">
											<s></s><a href="http://usergrade.tt.com/user/grade" target="_blank">金牌会员</a>
										</span>
                                    </div>
                                    <div class="shop-level">购物行为评级：<span><a target="_blank" href="http://help.tt.com/help/question-57.html#help2173">
										<s id="userCredit" class="rank-sh rank-sh01 rank-sh02"></s></a></span></div>
                                    <div>会员类型：个人用户</div>
                                </div>
                            </div>
							<div class="fr ac" style="width:280px;">
								  注：修改手机和邮箱请到<a class="ml5 ftx05" href="http://safe.tt.com/user/paymentpassword/safetyCenter.action">账户安全</a>
							</div>
                            <div class="clr"></div>
