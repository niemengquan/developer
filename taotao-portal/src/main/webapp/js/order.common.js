...
/*
OrderAppConfig.LoginUrl = "http://passport.tt.com/new/login.aspx?ReturnUrl="+OrderAppConfig.Domain+"/order/getOrderInfo.action";
*/
OrderAppConfig.LoginLocUrl = "http://passport.tt.com/new/login.aspx?ReturnUrl="+OrderAppConfig.Domain+"/order/getLocOrderInfo.action";
