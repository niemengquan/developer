 /*
 item.tt.com Compressed by uglify
 Author:keelii 
...
function seoBanner(t, e) {
    $.ajax({url: "http://seo.tt.com/adrpc/source.action",data: {cateid: G.cat[0],type: 5,ison: 1 === warestatus ? !0 : !1},dataType: "jsonp",success: function(t) {
...
function getSuitInfoService(t) {
    if (null !== t.packResponseList && t.packResponseList.length > 0) {
        ...
        $("#favorable-suit").show(), $("#favorable-suit .mc").html(suit_TPL.tabs.process(t) + suit_TPL.cons.process(t)), $("#favorable-suit .mc").Jtab({event: e >= t.packResponseList.length ? "mouseover" : "click",delay: 300,compatible: !0,currClass: "scurr"}, function(t, e) {
            ...
            }), l.attr("href", "http://www.tt.com/suit/show.html?suitId=" + s + "&skuIds=" + d.join(",")), e.find("img[data-src]").each(function() {
...
function renew() {
//    $.ajax({url: "http://d.tt.com/oldfornew/get?skuId=" + pageConfig.product.skuid,dataType: "jsonp",success: function(t) {
...
//                $(".renew-btn .css3-btn").attr("href", "http://trade.tt.com/order/getOrderInfo.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&rid=" + +new Date)
//            }))
//        }})
}
...
//    var e = t || G.sku;
//    $.ajax({url: "http://chat1.tt.com/api/checkChat?",data: {pid: e,returnCharset: "utf-8"},dataType: "jsonp",success: function(t) {
//            if (t) {
//                pageConfig.im = t;
...
function log(t, e) {
    ...
    for (i = 2; arguments.length > i; i++)
        s = s + arguments[i] + "|||";
    var a = decodeURIComponent(escape(getCookie("pin"))), n = "http://csc.tt.com/log.ashx?type1=$type1$&type2=$type2$&data=$data$&pin=$pin$&referrer=$referrer$&jinfo=$jinfo$&callback=?", o = n.replace(/\$type1\$/, escape(t));
    ...
    var r = ("https:" == document.location.protocol ? "https://mercuryssl" : "http://mercury") + ".tt.com/log.gif" + "?t=other.000000" + "&m=UA-J2011-1" + "&v=" + encodeURIComponent("t1=" + t + "$t2=" + e + "$p0=" + s) + "&ref=" + encodeURIComponent(document.referrer) + "&rm=" + (new Date).getTime(), c = new Image(1, 1);
    c.src = r
}
...
function setCookie(t, e, i) {
    var s = i, a = new Date;
    a.setTime(a.getTime() + 1e3 * 60 * 60 * 24 * s), document.cookie = t + "=" + escape(e) + ";expires=" + a.toGMTString() + ";path=/;domain=.tt.com"
}
function getCookie(t) {
    var e = document.cookie.match(RegExp("(^| )" + t + "=([^;]*)(;|$)"));
    return null != e ? unescape(e[2]) : null
...
function CombineShare(t) {
    ...
    }, t.title.length > 27 && (t.title = t.title.substr(0, 27) + "..."), this.shareParam = {sid: t.sid,rid: t.rid,title: t.title,content: t.content,imgUrl: this.imgs[0],url: t.url}, this.shareMap = {T2: {name: "sina",text: "\u65b0\u6d6a\u5fae\u535a",url: "http://share.tt.com/sina/login.action"},T3: {name: "qqWeibo",text: "\u817e\u8baf\u5fae\u535a",url: "http://share.tt.com/qqweibo/login.action"},T4: {name: "renren",text: "\u4eba\u4eba\u7f51",url: "http://share.tt.com/renren/login.action"},T5: {name: "kaixin",text: "\u5f00\u5fc3\u7f51",url: "http://share.tt.com/kaixin001/login.action"},T6: {name: "douban",text: "\u8c46\u74e3\u7f51",url: "http://share.tt.com/douban/login.action"}}, this.init()
}
if (G === void 0)
    var G = window.G = {};
(function(t) {
...
//        , $.ajax({url: "http://club.tt.com/ProductPageService.aspx?method=GetCommentSummaryBySkuId&referenceId=" + t + "&callback=getCommentCount",dataType: "script",cache: !0})
        , void 0)
    }, t.getCommentData = function(t, e, i, s, a) {
        t = t || [], e = e || $("body").eq(0), i = i || "p-comm-", s = s || "(\u5df2\u6709{NUM}\u4eba\u8bc4\u4ef7)", $.ajax({url: "http://club.tt.com/clubservice.aspx?method=GetCommentsCount&referenceIds=" + t,dataType: "jsonp",success: function(t) {
                var e;
        ...
        for (var i = $(t).parents(e), s = i.find(".master input").attr("wmeprice"), a = i.find("input:checked"), n = a.length, o = i.find(".infos .res-totalprice"), r = i.find(".infos .res-jdprice"), c = 0, l = 0, d = "http://cart.tt.com/cart/dynamic/reBuyForOrderCenter.action?wids={SKUS}&nums={NUMS}", p = i.find(".btn-buy"), m = [], u = 0; a.length > u; u++)
        ...
        var i = "http://mercury.tt.com/log.gif?", s = "src=" + t.name + "$action=" + t.action;
        ...
        "function" == typeof t && $.getJSON("http://passport.tt.com/loginservice.aspx?method=Login&callback=?", function(e) {
        ...
        var n = new Image, o = "http://mercury.tt.com/log.gif?t=rec." + t + "&v=" + encodeURIComponent("src=rec$action=" + e + "$enb=1$sku=" + i + "$csku=" + s + "$index=" + (a || 0) + "$expid=0") + "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer) + "&random=" + Math.random();
...
//        , 
//        $.ajax({url: "http://diviner.tt.com/diviner?" + decodeURIComponent($.param(i)),dataType: "jsonp",scriptCharset: "utf-8",success: function(t) {
//                e.set(t)
//            }})
    },set: function(t) {
        function e(t, e) {
        ...
        var s = $("#tab-hot"), a = {set: function(t, e) {
            ...
            i.unbind("click").bind("click", function() {
                ...
                }, $.ajax({url: "http://prs.tt.com/Pop/CodeServiceSize.aspx?callback=fetchJSON_sizeList",dataType: "script",cache: !0,data: o})
...
//        return !G.isJd && e ? !1 : (655 == G.cat[2] ? $.ajax({url: "http://rs.tt.com/accessorie/newServiceWhite.jsonp?sku=" + G.sku + "&callback=Recommend.cbNewFittings",dataType: "script",cache: !0,scriptCharset: "utf-8"}) : 830 == G.cat[1] ? $.ajax({url: "http://rs.tt.com/accessorie/accessoryByAccessory.jsonp?sku=" + G.sku + "&callback=Recommend.cbNewFittings",dataType: "script",cache: !0,scriptCharset: "utf-8"}) : G.cat[2] > 830 && 835 > G.cat[2] || 5012 === G.cat[2] ? $.ajax({url: "http://misc.360buyimg.com/product/js/2012/fittingsCamera.js?ver=20140424",dataType: "script",cache: !0,success: function() {
...
//            }}) : 6728 == G.cat[0] && G.isJd ? $.ajax({url: "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",dataType: "script",cache: !0}) : $.getJSONP("http://d.tt.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
        ...
        if (pageConfig.product.cbNewFittings = [pageConfig.product.skuid], pageConfig.setFittingsClk = function(t, e, i, s, a) {
            ...
            $("#newFittign-tab").prepend(s.tabs.process(t)).Jtab({event: "click",compatible: !0,currClass: "scurr"}, function(t, i, a) {
                ...
                if (830 != G.cat[1])
                    if (c.attr("href", "http://rs.tt.com/accessorie/center.html?sku=" + G.sku + "&thirdTypeId=" + o).html("\u8fdb\u5165" + r), n.scrollLeft(0), 0 !== a) {
                        ...
                        }, $.ajax({url: "http://rs.tt.com/accessorie/newServiceList.jsonp?sku=" + G.sku + "&thirdTypeId=" + o + "&callback=fetchJSON_fittingExtra",dataType: "script",cache: "true",scriptCharset: "utf-8"}), $("#newFittign-tab .suits").removeAttr("style").css({width: pageConfig.wideVersion && pageConfig.compatible ? 620 : 384,overflow: pageConfig.wideVersion && pageConfig.compatible ? "hidden" : "auto"})
                    } else
...
//                    "true" != t.attr("enabled") ? $.ajax({type: "GET",url: "http://club.tt.com/index.php",data: {mod: "ProductComment",action: "saveCommentUserfulVote",commentId: i,isUseful: s},dataType: "jsonp",success: function(e) {
...
var Refresh = {init: function() {
        ...
        return "" === t.content.replace(/\s+/, "") ? (alert("\u8bf7\u8f93\u5165\u56de\u590d\u5185\u5bb9"), !1) : 1 > s.length || s.length > 800 ? (alert("\u56de\u590d\u5185\u5bb9\u5e94\u57281~400\u4e2a\u5b57\u4ee5\u5185"), !1) : ($.ajax({url: "http://club.tt.com/index.php?",data: i,dataType: "jsonp",success: function(i) {
        ...
        var i = this, s = "http://club.tt.com/clubservice/newcomment-", a = "", n = e;
        switch (this.obj = n, t) {
            case 0:
                a = "Club";
                break;
        ...
        var t = this, e = "http://club.tt.com/clubservice/newcomment-Commp." + G.cat[2] + "-" + G.sku + ".html";
        ...
        }, $.getJSONP("http://club.tt.com/clubservice/newconsulation-" + G.orginSku + "-" + (t + 1) + ".html?callback=fetchJSON_Consult")
        ...
        $.jmsajax({url: "/newsserver.asmx",method: "PayExplain",data: {id: "A-product-0" + (t - 3)},success: function(i) {
                if (null != i) {
                    ...
                    6 === t ? $("#consult-6").html('<iframe src="http://psfw.tt.com/help/deliveryService.html" style="margin-top:10px;width:100%;height:' + s + 'px;border:none;"></iframe>') : e.html(i)
                }
            }})
    },search: function(t, e, i) {
        var s = "http://search.tt.com/sayword?", i = i || 0, t = t || G.orginSku, a = this;
        ...
        $.ajax({url: "http://wiki.tt.com/statistics/termFloat.action?",data: {id: t,t: +new Date},dataType: "script",cache: !0})
        ...
        var t = this;
        $.ajax({url: "http://wiki.tt.com/product/" + G.sku + "/keywords.html",dataType: "jsonp",success: function(e) {
                t.setKeywords(e)
            }})
        ...
        $.getJSONP("http://rms.shop.tt.com/json/pop/popcompany.action?callback=EvaluateGradeNew.setAddress&venderID=" + t)
        ...
        }, $.getJSONP("http://club.tt.com/clubservice/merchantcomment/" + G.sku + ".html?callback=fetchJSON_Eva"), this
    },getGradeDetail: function(t) {
        $.getJSONP("http://rms.shop.tt.com/json/popscore/scorefact.action?callback=EvaluateGradeNew.setGradeDetail&venderID=" + t)
        ...
        if (null !== t) {
            ...
            var i = this.popInfo ? "http://mall.tt.com/shopLevel-" + this.popInfo.id + ".html" : "#none";
...
//        var t = this;
//        $.ajax({url: "http://d.tt.com/yanbao2/get?skuId=" + this.sku,dataType: "jsonp",success: function(e) {
//                e && t.set(e)
//            }})
    },set: function(t) {
...
(function() {
    ...
    RegExp("-" + e + "-").test(t) && $("#choose-amount").hide(), (4835 == e || 4836 == e) && (setAmount.urlPerfix = "http://card.tt.com/order/order_place.action?", setAmount.data = null, setAmount.data = {skuId: G.sku}), 4833 == e && (setAmount.urlPerfix = "http://chongzhi.tt.com/order/order_place.action?", setAmount.data = null, setAmount.data = {skuId: G.sku})
}(), G.onAttr("HYKHSP", function() {
//    var t = "http://eve.tt.com/redirect.action?wid=" + G.sku + "&btype=0&r=" + Math.random(), e = $("#InitCartUrl");
//    e.attr({href: t,"data-origin": encodeURIComponent(t)})
    ...
    window.jdSref = t(), window.jdSuri = new JDS.uri(window.jdSref), window.searchEngineSource = i(window.jdSuri)
        ...
        var t = this;
        $.ajax({url: "http://share.tt.com/share/getBindStatus.action",dataType: "jsonp",success: function(e) {
        ...
        n.content = s, n.imgUrl = i, e.each(function() {
            var t = $(this).val();
            t && a.push(t)
        }), a.length && (n.type = a.join(","), $.ajax({url: "http://share.tt.com/share/shareItem.action",dataType: "jsonp",data: n,success: function(e) {
                var i = [], s = [];
...
//    G.isJd && "enabled" == pageConfig.btnBaiTiaoFq && t.after(e)
    ...
    pageConfig.product.havestock === void 0 ? (s = "", a = "http://cart.gift.tt.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = pageConfig.product.havestock ? "" : "disabled", pageConfig.product.havestock ? (s = "", a = "http://cart.gift.tt.com/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = "disabled", a = "#none")), 6980 == G.cat[2] && $('#product-detail [data-widget="tab-item"]').eq(3).hide(), $("#online-service").find("b").html("\u8054\u7cfb\u5ba2\u670d"), $("#comments-list li").eq(4).html('<a href="javascript:;">\u6709\u6652\u5355\u7684\u8bc4\u4ef7<em>(0)</em></a>'), $("body").addClass("cat-1-" + G.cat[0] + " cat-2-" + G.cat[1] + " cat-3-" + G.cat[2] + " item-" + G.sku), G.onAttr("HYKHSP-2", function() {
        setTimeout(function() {
...
//                }
        ...
        832 === G.cat[2] && (p = "737542"), d.addItem('<a class="research" target="_blank" href="http://surveys.tt.com/index.php?r=survey/index/sid/' + p + '/lang/zh-Hans"><b></b>\u8c03\u67e5\u95ee\u5377</a>'), d.setTop(), d.scroll()
    }
    ...
    (function() {
       ...
       // pageConfig.disabledSeoBanner || (t.push("2_163_5395"), t.push("2_163_5394")), 1315 === G.cat[0] && $("#Ad2_100_2272").length > 0 && t.push("2_100_2272"), G.isPop && t.push("2_601_3951"), $.ajax({url: "http://nfa.tt.com/loadFa_toJson.js?aid=" + t.join("-") + "&ver=20131107",dataType: "script",cache: !0}), insertScript("http://static.360buyimg.com/gemini/gemini/gemini_v2.2.1.js", {id: "1399174259281",name: "gemini_divide_script",charset: "utf-8",divideType: "MODULE_INJECT",param: "[{t:'xiaoyumi'}]"})
        ...
        G.isJd && (s += '            <div class="consult-pub">                <a class="css3-btn" target="_blank" href="http://club.tt.com/allconsultations/' + G.sku + '-1-1.html#form1">\u53d1\u8868\u54a8\u8be2</a>            </div>'), t.remove(), e.addClass("consult-2014"), e.find(".mt").append(s), window.closeCounsultSearch = function() {
...
//            e(t)
//        }, $.ajax({url: "http://nfa.tt.com/loadFa_toJson.js?aid=2_163_4827-2_163_4828",dataType: "jsonp",cache: !0,success: function() {
//            }})
        ...
        createCookie("__jda", "122270672." + i + ".043878.1386043878.1386043878.1", 10, "/;domain=tt.com"), 0
