...
function clothingAbTest() {
    if ("home" == pageConfig.navId) {
        ...
        if (a) {
            ...
            5e3 >= b ? (c.find("h3").html('<a href="http://channel.tt.com/1315-1342.html" clstag="homepage|keycount|home2013|0606a4">\u7537\u88c5</a>\u3001<a href="http://channel.tt.com/1315-1343.html" clstag="homepage|keycount|home2013|0606a3">\u5973\u88c5</a>\u3001<a href="http://channel.tt.com/1315-1345.html" clstag="homepage|keycount|home2013|0606a5">\u5185\u8863</a>\u3001<a href="http://channel.tt.com/jewellery.html" clstag="homepage|keycount|home2013|0606a6">\u73e0\u5b9d</a>'), d.attr("clstag", "homepage|keycount|home2013|0606b3"), e.attr("clstag", "homepage|keycount|home2013|0606b4")) : (c.find("h3").html('<a href="http://channel.tt.com/clothing.html" clstag="homepage|keycount|home2013|0606a1">\u670d\u9970\u5185\u8863</a>\u3001<a href="http://channel.tt.com/jewellery.html" clstag="homepage|keycount|home2013|0606a2">\u73e0\u5b9d\u9996\u9970</a>'), d.attr("clstag", "homepage|keycount|home2013|0606b1"), e.attr("clstag", "homepage|keycount|home2013|0606b2"))
        }
    }
}
!function() {
    var a = document.getElementById("nav-dapeigou");
    a && (a.innerHTML = '<a href="http://channel.tt.com/chaoshi.html">\u4eac\u4e1c\u8d85\u5e02</a>')
}(), "undefined" == typeof pageConfig.FN_getDomain && (pageConfig.FN_getDomain = function() {
    var a = location.hostname;
    return /tt.com/.test(a) ? "tt.com" : "tt.com"
}), function() {
    var a = $("#service-2013 a[href='http://en.tt.com/']");
    a.length && a.attr("href", "http://help.en.tt.com/help/question-2.html")
}(), function() {
...
!function() {
    ...
    a.Jtimer = function(b, c) {
        ...
        a.ajax({url: "http://qiang.tt.com/HomePageNewLimitBuy.ashx?callback=?",data: {ids: d.pids},dataType: "jsonp",success: function(b) {
    ...
    a.jdCalcul = function(b) {
        var c = null, b = b.join(","), d = "http://qiang.tt.com/HomePageNewLimitBuy.ashx?callback=?&ids=" + b, e = "http://item.tt.com/", f = function(b) {
...
var jdRecent = {element: $("#recent ul"),jsurl: "http://www.tt.com/lishiset.aspx?callback=jdRecent.setData&id=",cookiename: "_recent",list: $.cookie("_recent"),url: location.href,init: function() {
        ...
        $.cookie(this.cookiename, this.list, {expires: 7,path: "/",domain: "tt.com",secure: !1}), this.getData(this.list)
    },clear: function() {
        $.cookie(this.cookiename, "", {expires: 7,path: "/",domain: "tt.com",secure: !1})
    },getData: function(a) {
        if (0 == a)
...
var jdModelCallCenter = {settings: {clstag1: 0,clstag2: 0},tbClose: function() {
        ...
        return c ? (location.href = "https://passport." + pageConfig.FN_getDomain() + "/new/login.aspx?ReturnUrl=" + escape(location.href), void 0) : (setTimeout(function() {
            $.jdThickBox({type: "iframe",title: "\u60a8\u5c1a\u672a\u767b\u5f55",source: "http://passport.tt.com/uc/popupLogin2013?clstag1=" + a.settings.clstag1 + "&clstag2=" + a.settings.clstag2 + "&r=" + Math.random(),width: 390,height: 450,_title: "thicktitler",_close: "thickcloser",_con: "thickconr"})
        }, 20), void 0)
    }*/,regist: function() {
        var a = this;
        this.tbClose(), setTimeout(function() {
            $.jdThickBox({type: "iframe",title: "\u60a8\u5c1a\u672a\u767b\u5f55",source: "http://reg.tt.com/reg/popupPerson?clstag1=" + a.settings.clstag1 + "&clstag2=" + a.settings.clstag2 + "&r=" + Math.random(),width: 390,height: 450,_title: "thicktitler",_close: "thickcloser",_con: "thickconr"})
        }, 20)
    },init: function() {
//        var a = this;
...
$.extend(jdModelCallCenter, {autoLocation: function(a) {
        ...
        var b = "http://t.tt.com/product/followProduct.action?productId=" + a;
    ...
    return pageConfig.navId && "home" == pageConfig.navId && location.href.indexOf("www.tt.com") >= 0
...
//http://d.tt.com/configs/get?type=JSON
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_BrandsServ: "http://d.tt.com/brandVclist2/get?callback=category.getBrandService&ids=a,9211,9212^b,9214,9215^c,9217,9218^d,9220,9221^e,9223,9224^f,9226,9227^g,9229,9230^h,9232,9233^m,9235,9236^i,9238,9239^j,9241,9242^p,9244,9245^k,9247,9248^l,9250,9251",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.tt.com/" + c + ".html" : "http://www.taotao.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
        ...
        switch (a) {
            case "c":
                b = '<div class="categorys-links" ' + c + '><a href="http://group.tt.com/index/20000001.htm" target="_blank"><img src="http://img13.360buyimg.com/da/jfs/t328/179/568110786/5477/d602dfd5/54180c0eN5ddce4d3.png" /></a></div>';
                break;
            case "b":
                b = '<div class="categorys-links" id="categorys-links-cellphone" ' + d + '><a href="http://sale.tt.com/act/UaSsnjAKQNeyiY.html" target="_blank">JDPhone\u8ba1\u5212</a></div>';
                break;
            case "d":
                b = '<div class="categorys-links" id="categorys-links-jzc" ' + e + '><a href="http://channel.tt.com/jiazhuang.html" target="_blank">\u5bb6\u88c5\u57ce</a></div>'
        }
        return b
    },DATA_Simple: {1: [{l: "http://book.tt.com/",n: "\u56fe\u4e66"}, {l: "http://mvd.tt.com/",n: "\u97f3\u50cf"}, {l: "http://e.tt.com/",n: "\u6570\u5b57\u5546\u54c1"}],2: [{l: "http://channel.tt.com/electronic.html",n: "\u5bb6\u7528\u7535\u5668"}],3: [{l: "http://shouji.tt.com/",n: "\u624b\u673a"}, {l: "http://channel.tt.com/digital.html",n: "\u6570\u7801"}, {l: "http://mobile.tt.com/index.do",n: "\u4eac\u4e1c\u901a\u4fe1"}],4: [{l: "http://channel.tt.com/computer.html",n: "\u7535\u8111\u3001\u529e\u516c"}],5: [{l: "http://channel.tt.com/home.html",n: "\u5bb6\u5c45"}, {l: "http://channel.tt.com/furniture.html",n: "\u5bb6\u5177"}, {l: "http://channel.tt.com/decoration.html",n: "\u5bb6\u88c5"}, {l: "http://channel.tt.com/kitchenware.html",n: "\u53a8\u5177"}],6: [{l: "http://channel.tt.com/1315-1342.html",n: "\u7537\u88c5"}, {l: "http://channel.tt.com/1315-1343.html",n: "\u5973\u88c5"}, {l: "http://channel.tt.com/1315-1345.html",n: "\u5185\u8863"}, {l: "http://channel.tt.com/jewellery.html",n: "\u73e0\u5b9d"}],7: [{l: "http://channel.tt.com/beauty.html",n: "\u4e2a\u62a4\u5316\u5986"}],8: [{l: "http://channel.tt.com/shoes.html",n: "\u978b\u9774"}, {l: "http://channel.tt.com/bag.html",n: "\u7bb1\u5305"}, {l: "http://channel.tt.com/watch.html",n: "\u949f\u8868"}, {l: "http://channel.tt.com/1672-2615.html",n: "\u5962\u4f88\u54c1"}],9: [{l: "http://channel.tt.com/sports.html",n: "\u8fd0\u52a8\u6237\u5916"}],10: [{l: "http://channel.tt.com/auto.html",n: "\u6c7d\u8f66\u7528\u54c1"}],11: [{l: "http://channel.tt.com/baby.html",n: "\u6bcd\u5a74"}, {l: "http://channel.tt.com/toys.html",n: "\u73a9\u5177\u4e50\u5668"}],12: [{l: "http://channel.tt.com/food.html",n: "\u98df\u54c1\u996e\u6599"}, {l: "http://channel.tt.com/wine.html",n: "\u9152\u7c7b"}, {l: "http://channel.tt.com/freshfood.html",n: "\u751f\u9c9c"}],13: [{l: "http://channel.tt.com/health.html",n: "\u8425\u517b\u4fdd\u5065"}],14: [{l: "http://caipiao.tt.com/",n: "\u5f69\u7968"}, {l: "http://trip.tt.com/",n: "\u65c5\u884c"}, {l: "http://chongzhi.tt.com/",n: "\u5145\u503c"}, {l: "http://piao.tt.com/",n: "\u7968\u52a1"}]},TPL_Simple: '{for item in data}<div class="item fore${parseInt(item_index)}">    <span data-split="1" {if pageConfig.isHome} clstag="homepage|keycount|home2013|06{if parseInt(item_index)+1>9}${parseInt(item_index)+1}{else}0${parseInt(item_index)+1}{/if}a"{/if}>        <h3>{for sItem in item}{if sItem_index!=0}\u3001{/if}<a href="${sItem.l}">${sItem.n}</a>{/for}</h3>        <s></s>    </span></div>{/for}<div class="extra"><a href="http://www.tt.com/allSort.aspx">\u5168\u90e8\u5546\u54c1\u5206\u7c7b</a></div>',FN_InitSimple: function() {
      ...
      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
        ...
        b.push('<div class="extra"><a {if pageConfig.isHome}clstag="homepage|keycount|home2013|0614a"{/if} href="http://www.tt.com/allSort.aspx">\u5168\u90e8\u5546\u54c1\u5206\u7c7b</a></div>'), this.OBJ.attr("load", "1").html(b.join("")), $.bigiframe(this.OBJ), this.FN_GetBrands();
    ...
    }}, UC = {DATA_Cookie: "aview",TPL_UnRegist: '<div class="prompt">            <span class="fl">\u60a8\u597d\uff0c\u8bf7<a href="javascript:login()" clstag="homepage|keycount|home2013|04a">\u767b\u5f55</a></span>            <span class="fr"></span>        </div>',TPL_Regist: '<div class="prompt">                <span class="fl"><strong>${Name}</strong></span>                <span class="fr"><a href="http://home.tt.com/">\u53bb\u6211\u7684\u4eac\u4e1c\u9996\u9875&nbsp;&gt;</a></span>            </div>',TPL_OList: {placeholder: '<div id="jduc-orderlist"></div>',fragment: '<div class="orderlist">                <div class="smt">                    <h4>\u6700\u65b0\u8ba2\u5355\u72b6\u6001\uff1a</h4>                    <div class="extra"><a href="http://order.tt.com/center/list.action" target="_blank">\u67e5\u770b\u6240\u6709\u8ba2\u5355&nbsp;&gt;</a></div>                </div>                <div class="smc">                    <ul>                        {for item in orderList}                        <li class="fore${parseInt(item_index)+1}">                            <div class="p-img fl">                                {for image in item.OrderDetail}                                    {if image_index<2}                                        <a href="http://www.tt.com/product/${image.ProductId}.html" target="_blank"><img src="${pageConfig.FN_GetImageDomain(image.ProductId)}n5/${image.ImgUrl}" width="50" height="50" alt="${image.ProductName}" /></a>                                    {/if}                                {/for}                                {if item.OrderDetail.length>2}                                    <a href="${item.passKeyUrl}" target="_blank" class="more">\u66f4\u591a</a>                                {/if}                            </div>                            <div class="p-detail fr">                                \u8ba2\u5355\u53f7\uff1a${item.OrderId}<br />                                \u72b6\u3000\u6001\uff1a<span>${UC.FN_SetState(item.OrderState)}</span><br />                                \u3000\u3000\u3000\u3000<a href="${item.passKeyUrl}">\u67e5\u770b\u8be6\u60c5</a>                            </div>                        </li>                        {/for}                    </ul>                </div>            </div>'},TPL_UList: '<div class="uclist">                <ul class="fore1 fl">                    <li><a target="_blank" clstag="homepage|keycount|home2013|04b" href="http://order.tt.com/center/list.action">\u5f85\u5904\u7406\u8ba2\u5355<span id="num-unfinishedorder"></span></a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|04c" href="http://jd2008.tt.com/user_spzx.aspx">\u54a8\u8be2\u56de\u590d<span id="num-consultation"></span></a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|04d" href="http://t.tt.com/product/followProductList.action?isReduce=true">\u964d\u4ef7\u5546\u54c1<span id="num-reduction"></span></a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|shouhou" href="http://myjd.tt.com/repair/orderlist.action">\u8fd4\u4fee\u9000\u6362\u8d27</a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|04e" href="http://quan.tt.com/user_quan.action">\u4f18\u60e0\u5238<span id="num-ticket"></span></a></li>                </ul>                <ul class="fore2 fl">                    <li><a target="_blank" clstag="homepage|keycount|home2013|04i" href="http://t.tt.com/home/follow">\u6211\u7684\u5173\u6ce8&nbsp;&gt;</a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|04g" href="http://bean.tt.com/myJingBean/list">\u6211\u7684\u4eac\u8c46&nbsp;&gt;</a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|licai" href="http://trade.jr.tt.com/centre/browse.action">\u6211\u7684\u7406\u8d22&nbsp;&gt;</a></li>                    <li><a target="_blank" clstag="homepage|keycount|home2013|baitiao" href="http://baitiao.tt.com/creditUser/list">\u6211\u7684\u767d\u6761&nbsp;&gt;</a></li>                </ul>            </div>',TPL_VList: {placeholder: '<div class="viewlist">                <div class="smt" clstag="homepage|keycount|home2013|04k">                    <h4>\u6700\u8fd1\u6d4f\u89c8\u7684\u5546\u54c1\uff1a</h4>                    <div style="float:right;padding-right:9px;"><a style="border:0;color:#005EA7" href="http://my.tt.com/history/list.html" target="_blank">\u67e5\u770b\u6d4f\u89c8\u5386\u53f2&nbsp;&gt;</a></div>                </div>                <div class="smc" id="jduc-viewlist" clstag="homepage|keycount|home2013|04j">                    <div class="loading-style1"><b></b>\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019...</div>                    <ul class="lh hide"></ul>                </div>            </div>',fragment: '{for item in list}<li><a href="http://item.tt.com/${item.wid}.html" target="_blank" title="${item.wname}"><img src="${pageConfig.FN_GetImageDomain(item.wid)}n5/${item.imgUrl}" width="50" height="50" alt="${item.wname}" /></a></li>{/for}'},FN_SetState: function(a) {
        var a = a;
        ...
        b = e.join(","), $.getJSONP("http://my.tt.com/product/info.html?ids=" + b + "&jsoncallback=UC.FN_ShowVList")
    },FN_InitVList: function(a) {
        for (var b = JSON.parse(a), c = b.length, d = ",", e = 0; c > e; e++)
            new RegExp(b[e].s).test(d) || (d += b[e].s + ",");
        d = d.replace(/(^,*)|(,*$)/g, ""), $.getJSONP("http://my.tt.com/product/info.html?ids=" + d + "&jsoncallback=UC.FN_ShowVList")
        ...
        var a = document.getElementById("settleup") ? $("#settleup dl") : $("#settleup-2013 dl"), b = a.find("dd").eq(0), c = function(a) {
            ...
            if (d > 0 ? (b.html(MCART.TPL_List.wrap.process(a.Cart)), b.find("#settleup-content .smc").html(e + f + g + i + h), $("#settleup-url").attr("href", "http://cart.tt.com/cart/cart.html?r=" + +new Date)) : b.html(MCART.TPL_NoGoods), $.browser.msie && 6 == $.browser.version) {
...
!function() {
    pageConfig.FN_ImgError(document), $("img[data-lazyload]").Jlazyload({type: "image",placeholderClass: "err-product"}), category.FN_Init(), document.getElementById("shortcut") ? $("#shortcut .menu").Jdropdown({delay: 50}) : ($("#biz-service").Jdropdown({delay: 50}, function() {
        $.ajax({url: "http://www.tt.com/hotwords.aspx?position=new-index-002",dataType: "script",scriptCharset: "gb2312",cache: !0})
    }), $("#site-nav").Jdropdown({delay: 50}, function() {
        $.ajax({url: "http://www.tt.com/hotwords.aspx?position=new-index-003",dataType: "script",scriptCharset: "gb2312",cache: !0})
...
//        //MCART.FN_Refresh(), $("#settleup-url").attr("href", "http://cart.tt.com/cart/cart.html?r=" + +new Date)
//    }
//        
...
//        $.ajax({url: "http://search.tt.com/suggest.php?op=del&callback=?&key=" + encodeURIComponent(d),dataType: "jsonp",scriptCharset: "utf-8",beforeSend: function() {
